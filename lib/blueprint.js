...
MEIRO.Blueprint = class
{
	...
	update( )
	{
		...
		else
		{
			...
			for( var i=0; i<n; i++ )
			{
				this.imageFloors[i].material.opacity = opacityGradient( [1, 0.1, 0], this.showLevel-i );
				...
				this.imageStairs[i].material.opacity  = opacityGradient( [1.5, 0.1, 0], this.showLevel-i+0.5 );
			}
		}
