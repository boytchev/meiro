...
//	The blueprint retrieves data from a global dungeon instance.
//
//	MEIRO.BLUEPRINT
//	 ├─ TIMER
//	 ├─ SPEED
...
MEIRO.Blueprint = class
{
	constructor( dungeon )
	{
		...
		// add a frame of the whole dungeon
	...
	update( )
	{
		...
		else
		{
			...
			for( var i=0; i<n; i++ )
			{
				...
				this.floors[i].material.opacity = 1.0*opacity + 0.3*subOpacity;
