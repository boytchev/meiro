...
//	Модел 23441 - Гладкост G0/C0 с квадратични криви на Безие
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M23441 = function M23441(room)
{
...
MEIRO.Models.M23441.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M23441.DIST = {MIN:10, MAX:30, HEIGHT:0};
MEIRO.Models.M23441.POS = {DIST:20, ROT_X:1.571, ROT_Y:0};
MEIRO.Models.M23441.ROT_Y = {MIN:-0.1, MAX:0.7};


MEIRO.Models.M23441.prototype.bezierCurve = function(t,P0,P1,P2)
{
...
// аниматор на модела
MEIRO.Models.M23441.prototype.onAnimate = function(time)
{
	this.t += this.speed;
...
MEIRO.Models.M23441.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Гладкост G<sup>0</sup>/C<sup>0</sup> с квадратични криви на Безие</h1>';

	s += '<p>Две квадратични криви на Безие се съшиват с гладкост <em>G<sup>0</sup></em> или <em>C<sup>0</sup></em> като последната точка на едната съвпада с първата точка на другата. Така двете криви формират една непрекъсната крива с гладкост <em>G<sup>0</sup></em> или <em>C<sup>0</sup></em>.</p>';
...
MEIRO.Models.M23441.prototype.onToggle = function(element)
{
	var that = this;
