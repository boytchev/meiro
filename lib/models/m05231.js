...
//	Модел 05231 - Най-близка точка от права
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M05231 = function M05231(room)
{
	...
	this.to = new THREE.Vector3(0,1,0);
	this.line = new MEIRO.Cylinder(0.2,20);
...
MEIRO.Models.M05231.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M05231.DIST = {MIN:10, MAX:30, HEIGHT:-1};
MEIRO.Models.M05231.POS = {DIST:20, ROT_X:1.3, ROT_Y:0.1};
MEIRO.Models.M05231.ROT_Y = {MIN:-0.1, MAX:0.7};



// аниматор на модела
MEIRO.Models.M05231.prototype.onAnimate = function(time)
{
	// координатна система
...
MEIRO.Models.M05231.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Най-близка точка от права</h1>';
	
	s += '<p>Изчисляването на най-краткото разстояние от дадена точка до права и намирането на съответната най-близка точка от тази права може да се направи изцяло векторно. Този начин се използва както в равнината, така и в пространството.</p>';
...
MEIRO.Models.M05231.prototype.onToggle = function(element)
{
	var that = this;
	new TWEEN.Tween(
