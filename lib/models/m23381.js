...
//	Модел 23381 - Крива на Безие при n=3
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M23381 = function M23381(room)
{
...
MEIRO.Models.M23381.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M23381.DIST = {MIN:10, MAX:30, HEIGHT:0};
MEIRO.Models.M23381.POS = {DIST:20, ROT_X:1.571, ROT_Y:0};
MEIRO.Models.M23381.ROT_Y = {MIN:-0.1, MAX:0.7};


MEIRO.Models.M23381.prototype.bezierCurve = function(t)
{
	...
	p.addScaledVector(this.points[3].position,B3);
	return p;
}


// аниматор на модела
MEIRO.Models.M23381.prototype.onAnimate = function(time)
{
	this.t += this.speed;
...
MEIRO.Models.M23381.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Крива на Безие при n=3</h1>';

	s += '<p>Крива на Безие <em>Q</em> при <em>n=3</em> е кубична и се определя от четири точки: <em>Q(t) = (1-t)<sup>3</sup>P<sub>0</sub> + 3t(1-t)<sup>2</sup>P<sub>1</sub> + 3t<sup>2</sup>(1-t)P<sub>2</sub> + t<sup>3</sup>P<sub>3</sub></em>. Кривата започва от <em>P<sub>0</sub></em> и завършва в <em>P<sub>3</sub></em>, като се съдържа изцяло в изпъкналата обвивка на четириъгълника <em>P<sub>0</sub>P<sub>1</sub>P<sub>2</sub>P<sub>3</sub></em>.</p>';
...
MEIRO.Models.M23381.prototype.onToggle = function(element)
{
	var that = this;
