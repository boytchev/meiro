...
//	Модел 14492 - Пръстени от пешки обърнати навътре
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M14492 = function M14492(room, model)
{
	...
	this.ring = new THREE.Mesh(
		new THREE.CylinderGeometry(4.25,4.25,2,18,1,true),
...
MEIRO.Models.M14492.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M14492.DIST = {MIN:10, MAX:30, HEIGHT:0};
MEIRO.Models.M14492.POS = {DIST:20, ROT_X:-0.9, ROT_Y:0};
MEIRO.Models.M14492.ROT_Y = {MIN:-0.1, MAX:0.7};



// аниматор на модела
MEIRO.Models.M14492.prototype.onAnimate = function(time)
{	
...
MEIRO.Models.M14492.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Пръстени от пешки обърнати навътре</h1>';
