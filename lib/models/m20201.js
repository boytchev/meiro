...
//	Модел 20201 - Хоризонтално въртене на 3D сцена
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M20201 = function M20201(room)
{
...
MEIRO.Models.M20201.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M20201.DIST = {MIN:10, MAX:20, HEIGHT:0};
MEIRO.Models.M20201.POS = {DIST:15, ROT_X:0.57, ROT_Y:0.3};
MEIRO.Models.M20201.ROT_Y = {MIN:-0.1, MAX:0.7};


// аниматор на модела
MEIRO.Models.M20201.prototype.onAnimate = function(time)
{
	this.oxyz.rotateLabels();
	
	this.s.set(15,Math.PI/2-0.05,rpm(time,10));
...
MEIRO.Models.M20201.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Хоризонтално въртене на 3D сцена</h1>';

	s += '<p>Хоризонталното въртенето на тримерна сцена се реализира чрез движение на гледната точка в кръг, като векторът "нагоре" и позицията, към която се гледа, са фиксирани.</p>';
...
MEIRO.Models.M20201.prototype.onToggle = function(element)
{	
...
MEIRO.Models.M20201.prototype.onEnter = function()
{
...
MEIRO.Models.M20201.prototype.onExit = function()
{
