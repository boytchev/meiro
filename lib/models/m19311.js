...
//	Модел 19311 - Мащабиране с матрица спрямо точка
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M19311 = function M19311(room)
{
...
MEIRO.Models.M19311.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M19311.DIST = {MIN:10, MAX:40, HEIGHT:0};
MEIRO.Models.M19311.POS = {DIST:20, ROT_X:0.57, ROT_Y:0.3};
MEIRO.Models.M19311.ROT_Y = {MIN:-0.1, MAX:0.7};


// аниматор на модела
MEIRO.Models.M19311.prototype.onAnimate = function(time)
{
...
MEIRO.Models.M19311.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Мащабиране с матрица спрямо точка</h1>';

	s += '<p>Матрицата за мащабиране използва за център на мащаба точката <em>(0,0,0)</em>. Ако трябва да се използва друг център, то първо се прави транслация от желания център до <em>(0,0,0)</em>, после се мащабира и накрая се прави обратна транслация до точката.</p>';
...
MEIRO.Models.M19311.prototype.onToggle = function(element)
{	
