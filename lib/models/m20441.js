...
//	Модел 20441 - Матрица за ортогонална проекция
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M20441 = function M20441(room)
{
...
MEIRO.Models.M20441.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M20441.DIST = {MIN:5, MAX:20, HEIGHT:0, SHIFT_Z:-5};
MEIRO.Models.M20441.POS = {DIST:15, ROT_X:3, ROT_Y:0.3};
MEIRO.Models.M20441.ROT_Y = {MIN:-0.1, MAX:0.7};


// аниматор на модела
MEIRO.Models.M20441.prototype.onAnimate = function(time)
{
...
MEIRO.Models.M20441.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Матрица за ортогонална проекция</h1>';

	s += '<p>Ако проекционната равнина се намира на <em>z = f</em>, то матрицата <em>M</em> на проекцията е :</p>';
	s += '<p><pre>    |1 0 0 0|<br>M = |0 1 0 0|<br>    |0 0 0 f|<br>    |0 0 0 1|</pre></p>';
