...
//	Модел 27282 - Текстури върху обекти
//	П. Бойчев, 2017



// конструктор на модела
MEIRO.Models.M27282 = function M27282(room, model)
{
...
MEIRO.Models.M27282.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M27282.DIST = {MIN:5, MAX:15, HEIGHT:0};
MEIRO.Models.M27282.POS = {DIST:10, ROT_X:0.3, ROT_Y:0.3};
MEIRO.Models.M27282.ROT_Y = {MIN:-0.3, MAX:0.7};



// аниматор на модела
MEIRO.Models.M27282.prototype.onAnimate = function(time)
{
...
MEIRO.Models.M27282.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Текстури върху обекти</h1>';

	s += '<p>При добавянето на текстура върху геометрични обекти се запазва формата на обектите. В резултат на това изображението на текстурата може да се деформира, за да "приеме" съответната форма.</p>';
...
MEIRO.Models.M27282.prototype.onToggle = function(element)
{
	var that = this;
