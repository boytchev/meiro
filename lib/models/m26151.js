...
//	Модел 26151 - Смаляване на горните етажи
//	П. Бойчев, 2017


// конструктор на модела
MEIRO.Models.M26151 = function M26151(room)
{
...
MEIRO.Models.M26151.prototype = Object.create(MEIRO.Model.prototype);

MEIRO.Models.M26151.DIST = {MIN:10, MAX:30, HEIGHT:0};
MEIRO.Models.M26151.POS = {DIST:15, ROT_X:0, ROT_Y:0};
MEIRO.Models.M26151.ROT_Y = {MIN:-0.1, MAX:0.7};


// аниматор на модела
MEIRO.Models.M26151.prototype.onAnimate = function(time)
{
...
MEIRO.Models.M26151.prototype.onInfo = function(element)
{
	var s = '';
	s += '<h1>Смаляване на горните етажи</h1>';

	s += '<p>Всяка от пагодите е реализирана като слоеве от еднакви етажи. За да се получи смаляване на етажите, на всеки слой е добавен мащаб с коефициент 0.85. Така всеки етаж е с 15% по-малък от този под него.</p>';
	element.innerHTML = s;
}
